...
.. code-block:: shell
   ...
   wget https://repo.radeon.com/rocm/installer/rocm-runfile-installer/rocm-rel-10.0/rocm-installer-10.0.0-7.run
...
.. code-block:: shell
   ...
   bash rocm-installer-10.0.0-7.run help
   bash rocm-installer-10.0.0-7.run version
   bash rocm-installer-10.0.0-7.run buildinfo
   bash rocm-installer-10.0.0-7.run gfx=list
   bash rocm-installer-10.0.0-7.run compo=list
...
.. code-block:: shell
   ...
   bash rocm-installer-10.0.0-7.run
...
.. code-block:: shell
   ...
   bash rocm-installer-10.0.0-7.run <options>
...
.. code-block:: shell
   ...
   bash rocm-installer-10.0.0-7.run rocm
...
.. code-block:: shell
   ...
   bash rocm-installer-10.0.0-7.run deps=install gfx=gfx942 rocm

This example demonstrates how to install ROCm to a custom location with GPU access configuration:

.. code-block:: shell

   bash rocm-installer-10.0.0-7.run deps=install target="$HOME/myrocm" gfx=gfx942 rocm gpu-access=all
...
.. code-block:: shell
   ...
   bash rocm-installer-10.0.0-7.run gfx=gfx942,gfx950,gfx1100 rocm

Install all available architectures:

.. code-block:: shell

   bash rocm-installer-10.0.0-7.run gfx=all rocm
...
.. code-block:: shell
   ...
   bash rocm-installer-10.0.0-7.run gfx=gfx942 rocm

Install core SDK with dependencies:

.. code-block:: shell

   bash rocm-installer-10.0.0-7.run deps=install compo=core-sdk gfx=gfx942 rocm

Install multiple components:

.. code-block:: shell

   bash rocm-installer-10.0.0-7.run compo=core,dev-tools gfx=gfx942 rocm
...
.. code-block:: shell
   ...
   bash rocm-installer-10.0.0-7.run deps=install gfx=gfx942 rocm graphics
...
.. code-block:: shell
   ...
   bash rocm-installer-10.0.0-7.run amdgpu

Install AMD GPU Driver with dependencies:

.. code-block:: shell

   bash rocm-installer-10.0.0-7.run deps=install amdgpu
...
.. code-block:: shell
   ...
   bash rocm-installer-10.0.0-7.run deps=install gfx=gfx942 rocm amdgpu gpu-access=all

Install to custom location with all components:

.. code-block:: shell

   bash rocm-installer-10.0.0-7.run deps=install target="$HOME/myrocm" gfx=gfx942 rocm amdgpu gpu-access=all
...
* ``noexec``
  ...
  For example, extract the ``.run`` file and then use ``rocm-installer.sh`` instead of ``rocm-installer-10.0.0-7.run``
  to install ROCm and the AMD GPU Driver separately:

  .. code-block:: shell

     bash rocm-installer-10.0.0-7.run noexec
     cd rocm-installer
...
* ``deps=list <rocm/amdgpu/graphics>``
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run deps=list rocm
     bash rocm-installer-10.0.0-7.run deps=list amdgpu
     bash rocm-installer-10.0.0-7.run deps=list graphics
     bash rocm-installer-10.0.0-7.run deps=list rocm amdgpu graphics
...
* ``deps=validate <rocm/amdgpu/graphics>``
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run deps=validate rocm
     bash rocm-installer-10.0.0-7.run deps=validate amdgpu
     bash rocm-installer-10.0.0-7.run deps=validate graphics
     bash rocm-installer-10.0.0-7.run deps=validate rocm amdgpu graphics
...
* ``deps=install``
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run deps=install rocm
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run deps=install graphics

  To install the dependencies for ROCm, AMD GPU Driver, and graphics support, the command line is as follows:

  .. code-block:: shell

     bash rocm-installer-10.0.0-7.run deps=install rocm amdgpu graphics
  ...
  .. note::
     ...
     .. code-block:: shell
        ...
        bash rocm-installer-10.0.0-7.run deps=install-only rocm
        bash rocm-installer-10.0.0-7.run deps=install-only amdgpu
        bash rocm-installer-10.0.0-7.run deps=install-only graphics
        bash rocm-installer-10.0.0-7.run deps=install-only rocm amdgpu graphics
...
* ``target=<directory>``
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run target="/opt" gfx=gfx942 rocm

  To install ROCm to a directory called ``amd/myrocm`` in the ``$USER`` directory:

  .. code-block:: shell

     bash rocm-installer-10.0.0-7.run target="$HOME/myrocm" gfx=gfx942 rocm
...
* ``gfx=<arch>``
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run gfx=gfx942 rocm
     bash rocm-installer-10.0.0-7.run gfx=gfx1100 rocm
     bash rocm-installer-10.0.0-7.run gfx=gfx950 rocm
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run gfx=show           # Detect and display GPU info
     bash rocm-installer-10.0.0-7.run gfx=list           # List available architectures
     bash rocm-installer-10.0.0-7.run gfx=list-installed # Show installed architectures
...
* ``compo=<component_list>``
  ...
  * ``opencl``: OpenCL runtime
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run compo=core gfx=gfx942 rocm
     bash rocm-installer-10.0.0-7.run compo=core-sdk gfx=gfx942 rocm
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run compo=core,dev-tools gfx=gfx942 rocm
     bash rocm-installer-10.0.0-7.run compo=core-sdk,opencl gfx=gfx942 rocm
...
* ``graphics``
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run gfx=gfx942 rocm graphics
     bash rocm-installer-10.0.0-7.run deps=install gfx=gfx942 rocm graphics
...
* ``amdgpu``
  ...
  .. note::
     ...
     .. code-block:: shell
        ...
        bash rocm-installer-10.0.0-7.run gfx=gfx942 rocm amdgpu
...
* ``postrocm``
  ...
  * You want to run post-install on an existing installation.
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run gfx=gfx942 rocm nopostrocm
     bash rocm-installer-10.0.0-7.run postrocm
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run target=/custom/path postrocm
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run gfx=gfx942 postrocm

  Run post-install with a specific component:

  .. code-block:: shell

     bash rocm-installer-10.0.0-7.run compo=core-sdk postrocm
...
* ``gpu-access=<access_type>``
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run gfx=gfx942 rocm gpu-access=user
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run gfx=gfx942 rocm gpu-access=all
...
* ``uninstall-rocm (target=<directory>) (gfx=<arch>)``
  ...
  * Uninstall with auto-detection of architecture:
    ...
    .. code-block:: shell
       ...
       bash rocm-installer-10.0.0-7.run uninstall-rocm

    To uninstall ROCm from a custom location:

    .. code-block:: shell

       bash rocm-installer-10.0.0-7.run target="$HOME/myrocm/rocm-x.y.z" uninstall-rocm
  ...
  * Uninstall with architecture selection:
    ...
    .. code-block:: shell
       ...
       bash rocm-installer-10.0.0-7.run gfx=gfx1100 uninstall-rocm
       bash rocm-installer-10.0.0-7.run target="$HOME/myrocm" gfx=gfx942 uninstall-rocm

    To uninstall all architectures:

    .. code-block:: shell

       bash rocm-installer-10.0.0-7.run gfx=all uninstall-rocm
...
* ``uninstall-amdgpu``
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run uninstall-amdgpu
...
* ``findrocm``
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run findrocm
...
* ``manifest``
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run manifest

  To list components for a specific architecture:

  .. code-block:: shell

     bash rocm-installer-10.0.0-7.run manifest=gfx942
     bash rocm-installer-10.0.0-7.run manifest=gfx1100
     bash rocm-installer-10.0.0-7.run manifest=base
...
* ``assumeyes``
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run deps=install gfx=gfx942 rocm assumeyes
...
* ``verbose``
  ...
  .. code-block:: shell
     ...
     bash rocm-installer-10.0.0-7.run target="/opt" gfx=gfx942 rocm prompt verbose
...
* **Issue:** Cannot access GPU after installation
  ...
  * Add your user to the video/render groups: ``bash rocm-installer-10.0.0-7.run gpu-access=user``
  * Grant access to all users: ``bash rocm-installer-10.0.0-7.run gpu-access=all``
...
* **Issue:** Multi-architecture installation conflicts
  ...
  * Check installed architectures: ``bash rocm-installer-10.0.0-7.run gfx=list-installed``
  * Remove specific architecture if needed: ``bash rocm-installer-10.0.0-7.run gfx=gfx1100 uninstall-rocm``
