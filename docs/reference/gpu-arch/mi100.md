...
![Structure of a single GCD in the AMD Instinct MI100 GPU](./images/image004.png "Node-level system architecture with two AMD EPYC™ processors and eight AMD Instinct™ GPUs.")
...
![Structure of the AMD Instinct GPU (MI100 generation)](./images/image005.png "Structure of the AMD Instinct GPU (MI100 generation)")
...
![Block diagram of an MI100 compute unit with detailed SIMD view of the AMD CDNA architecture](./images/image006.png "An MI100 compute unit with detailed SIMD view of the AMD CDNA architecture")
