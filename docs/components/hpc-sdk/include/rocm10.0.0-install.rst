.. selected:: rocm-ver=10.0.0
   ...
   .. selected:: i=tar
      ...
      refer to `Install AMD ROCm 10.0.0
      <https://rocm.docs.amd.com/en/docs-10.0.0/install/rocm.html>`__ and
         ...
         2. Use the following command to install HPC SDK for your ``gfx950`` GPU:
            ...
            .. selected:: os=ubuntu os=debian
               ...
               .. code-block:: bash
                   ...
                   sudo apt install amdrocm-hpc10.0-gfx950 amdrocm-hpc-sdk10.0-gfx950
         ...
         2. Use the following command to install HPC SDK for your ``gfx942`` GPU:
            ...
            .. selected:: os=ubuntu os=debian
               ...
               .. code-block:: bash
                   ...
                   sudo apt install amdrocm-hpc10.0-gfx942 amdrocm-hpc-sdk10.0-gfx942
         ...
         2. Use the following command to install HPC SDK for your ``gfx90a`` GPU:
            ...
            .. selected:: os=ubuntu os=debian
               ...
               .. code-block:: bash
                   ...
                   sudo apt install amdrocm-hpc10.0-gfx90a amdrocm-hpc-sdk10.0-gfx90a
         ...
         2. Use the following command to install HPC SDK for your ``gfx908`` GPU:
            ...
            .. selected:: os=ubuntu os=debian
               ...
               .. code-block:: bash
                   ...
                   sudo apt install amdrocm-hpc10.0-gfx908 amdrocm-hpc-sdk10.0-gfx908
         ...
         2. Use the following command to install HPC SDK for your ``gfx1200`` GPU:
            ...
            .. selected:: os=ubuntu os=debian
               ...
               .. code-block:: bash
                   ...
                   sudo apt install amdrocm-hpc10.0-gfx1200 amdrocm-hpc-sdk10.0-gfx1200
         ...
         2. Use the following command to install HPC SDK for your ``gfx1201`` GPU:
            ...
            .. selected:: os=ubuntu os=debian
               ...
               .. code-block:: bash
                   ...
                   sudo apt install amdrocm-hpc10.0-gfx1201 amdrocm-hpc-sdk10.0-gfx1201
         ...
         2. Use the following command to install HPC SDK for your ``gfx1100`` GPU:
            ...
            .. selected:: os=ubuntu os=debian
               ...
               .. code-block:: bash
                   ...
                   sudo apt install amdrocm-hpc10.0-gfx1100 amdrocm-hpc-sdk10.0-gfx1100
         ...
         2. Use the following command to install HPC SDK for your ``gfx1101`` GPU:
            ...
            .. selected:: os=ubuntu os=debian
               ...
               .. code-block:: bash
                   ...
                   sudo apt install amdrocm-hpc10.0-gfx1101 amdrocm-hpc-sdk10.0-gfx1101
         ...
         2. Use the following command to install HPC SDK for your ``gfx1102`` GPU:
            ...
            .. selected:: os=ubuntu os=debian
               ...
               .. code-block:: bash
                   ...
                   sudo apt install amdrocm-hpc10.0-gfx1102 amdrocm-hpc-sdk10.0-gfx1102
         ...
         2. Use the following command to install HPC SDK for your ``gfx1103`` GPU:
            ...
            .. selected:: os=ubuntu os=debian
               ...
               .. code-block:: bash
                   ...
                   sudo apt install amdrocm-hpc10.0-gfx1103 amdrocm-hpc-sdk10.0-gfx1103
         ...
         2. Use the following command to install HPC SDK for your ``gfx1151`` GPU:
            ...
            .. selected:: os=ubuntu os=debian
               ...
               .. code-block:: bash
                   ...
                   sudo apt install amdrocm-hpc10.0-gfx1151 amdrocm-hpc-sdk10.0-gfx1151
         ...
         2. Use the following command to install HPC SDK for your ``gfx1150`` GPU:
            ...
            .. selected:: os=ubuntu os=debian
               ...
               .. code-block:: bash
                   ...
                   sudo apt install amdrocm-hpc10.0-gfx1150 amdrocm-hpc-sdk10.0-gfx1150
         ...
         2. Use the following command to install HPC SDK for your ``gfx1152`` GPU:
            ...
            .. selected:: os=ubuntu os=debian
               ...
               .. code-block:: bash
                   ...
                   sudo apt install amdrocm-hpc10.0-gfx1152 amdrocm-hpc-sdk10.0-gfx1152
         ...
         2. Use the following command to install HPC SDK for your ``gfx1153`` GPU:
            ...
            .. selected:: os=ubuntu os=debian
               ...
               .. code-block:: bash
                   ...
                   sudo apt install amdrocm-hpc10.0-gfx1153 amdrocm-hpc-sdk10.0-gfx1153
