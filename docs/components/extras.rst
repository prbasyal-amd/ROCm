...
* `ROCm Validation Suite <https://rocm.docs.amd.com/projects/ROCmValidationSuite/en/docs-1.5.122/index.html>`_ (RVS) -- A suite of tests for validating ROCm installations
  ...
  * :doc:`TransferBench <https://rocm.docs.amd.com/projects/TransferBench/en/docs-1.66.02/>` -- A utility for benchmarking simultaneous memory transfers between user-specified devices (CPUs, GPUs, and NICs). This component is part of the ROCmValidationSuite (RVS) and is installed with it.
