...
.. container:: format-big-table
  ...
  .. csv-table::
      ...
      ,gfx1101 [#RDNA-OS-700]_ [#rd-v710],gfx1101 [#RDNA-OS]_ [#7700XT-OS]_,
      ,gfx1100 [#RDNA-OS-700]_,gfx1100,gfx1100
      ,gfx1030 [#RDNA-OS-700]_ [#rd-v620]_,gfx1030,gfx1030
      ,gfx942 [#mi325x-os]_ [#mi300x-os]_[#mi300A-os],gfx942,gfx942
...
.. [#mi300x-os] AMD Instinct MI300X GPU (gfx942) is supported on all below listed :ref:`supported_distributions`.
